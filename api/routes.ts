...
export const apiRoutes = {
  ...
  "playlist/:id": (userId: string, id: string) =>
    `${server}/user/${userId}/playlist/${id}`,

  // Games
  popular: () => `${server}/public/games/popular`,
  new: () => `${server}/public/games/new`,
  "highest-rated": () => `${server}/public/games/highest-rated`,
  ...
  "reviews/:id": (id: string | number, reviewId: string) =>
    `${server}/games/${id}/reviews/${reviewId}`,
};
